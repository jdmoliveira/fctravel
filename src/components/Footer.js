  ...
  render() {
    return(
      <div className = "Footer" >
        ...
        <img src={boat_logo} style={{"transform":"scale(1.5)", "marginLeft":"45vh","marginTop":"65vh","float":"middle"}} className="Boat-logo" alt="boat_logo" />
        <img src={train_logo} style={{"transform":"scale(1)scaleX(1.3)", "marginRight":"13vh","marginTop":"65vh", "float":"right"}} className="Train-logo" alt="train_logo" />
      </div>
    )
  }
}
